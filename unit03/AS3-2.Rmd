...
```{r}
#可口可樂公司股價最高的日子
CocaCola$Date[which.max(CocaCola$StockPrice)]#1/1/73
#可口可樂公司股價最低的日子
CocaCola$Date[which.min(CocaCola$StockPrice)]#3/1/80
