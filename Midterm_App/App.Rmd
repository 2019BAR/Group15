...
Column 2 {.tabset data-width=70%}
-----------------------------------------------------------------------

### 訂單所在地區

![](img/Regional_Analysis/Picture1.png)

### 賣家分佈地圖

![](img/Regional_Analysis/Picture2.png)

### 消費者分布地圖

![](img/Regional_Analysis/Picture3.png)

### 總銷售金額分佈

![](img/Regional_Analysis/Picture4.png)

### 總運費金額分佈

![](img/Regional_Analysis/Picture5.png)


Column2 {data-width=30%}
-----------------------------------------------------------------------
...
文字分析 {data-icon="fa-calendar" data-navmenu="資料探索"}
=====================================================================
