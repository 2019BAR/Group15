...
```{r}
tscocacola = as.POSIXct(CocaCola$Date, format="%m/%d/%y")
nucocacola = as.numeric(format(tscocacola,'%y'))
hist(tscocacola[nucocacola ==83],CocaCola$StockPrice, 
     xlab="year", ylab = "stockprice", 
     main = "CocaCola", breaks = "month",las=2) 
tsProcterGamble= as.POSIXct(ProcterGamble$Date, format="%m/%d/%y")
plot(tsProcterGamble,ProcterGamble$StockPrice, 
     xlab="year", ylab = "stockprice", 
     main = "Procter Gamble", col = "red") 
```
